 ...
 * $Id: fortranobject.c,v 1.28 2002/12/07 23:59:34 pearu Exp $
 */
...
/*      printf("instep=%d outstep=%d\n\n",instep,outstep); */
  ...
  if (NULL == nd_index ) {
    fprintf(stderr,"copy_ND_array: could not allocate memory for index array.\n");
    return -1;
  }
